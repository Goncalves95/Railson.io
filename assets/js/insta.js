...
const ACCESS_TOKEN = 'IGQWRQMUtkTzZAvZATNTazFvblhjX29YSzZAGT2hqVUFvRE13bjRjU1ZAQYktxNUpoSEpYUjVkR194NzNJWldsRF9RZAmhEUTB0QVJNd003NFFmZAUpia1dFWk1zZAHA5VjM4N1RTNTBHX0dEczNmclBsQ3hyNVZAUMDZABbTAZD';
const USER_ID = '743207218';

// Função para obter os dados do feed do Instagram e exibir as fotos no site
function getInstagramFeed() {
    fetch(`https://graph.instagram.com/${USER_ID}/media?fields=id,caption,media_type,media_url,permalink,thumbnail_url,timestamp&access_token=${ACCESS_TOKEN}`, {
        method: 'GET',
    })
